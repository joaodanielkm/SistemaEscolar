...
namespace Sistema_Escolar
{
    public partial class formHome : Form
    {
        ...
        private void Home_Load(object sender, EventArgs e)
        {
            ...
            dtgListaDeAlunos.Columns[8].HeaderText = "CEP";
            dtgListaDeAlunos.Columns[8].DataPropertyName = nameof(Aluno.CEP);
            dtgListaDeAlunos.Columns[8].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dtgListaDeAlunos.Columns[9].HeaderText = "Telefone";
            dtgListaDeAlunos.Columns[9].DataPropertyName = nameof(Aluno.Telefone);
            dtgListaDeAlunos.Columns[9].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dtgListaDeAlunos.Columns[10].HeaderText = "Fone Contato";
            dtgListaDeAlunos.Columns[10].DataPropertyName = nameof(Aluno.Contato);
            dtgListaDeAlunos.Columns[10].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dtgListaDeAlunos.Columns[11].HeaderText = "Contato";
            dtgListaDeAlunos.Columns[11].DataPropertyName = nameof(Aluno.ContatoNome);
            dtgListaDeAlunos.Columns[11].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dtgListaDeAlunos.Columns[12].HeaderText = "Obs";
            dtgListaDeAlunos.Columns[12].DataPropertyName = nameof(Aluno.Obs);
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                int sel = dtgListaDeAlunos.CurrentRow.Index;
                lblStatus.Text = Convert.ToString(dtgListaDeAlunos["Nome", sel].Value);
                processoAluno.DeletaAluno(Convert.ToString(dtgListaDeAlunos["Nome", sel].Value));
            }
