...
namespace Sistema_Escolar
{
    public partial class formHome : Form
    {
        ...
        private void Home_Load(object sender, EventArgs e)
        {
            ...
            dtgListaDeAlunos.Columns[5].HeaderText = "Nacionalidade";
            ...
            dtgListaDeAlunos.Columns[0].Width = 78;
            dtgListaDeAlunos.Columns[1].Width = 350;
            dtgListaDeAlunos.Columns[2].Width = 100;
            dtgListaDeAlunos.Columns[3].Visible = false;
            dtgListaDeAlunos.Columns[4].Visible = false;
            dtgListaDeAlunos.Columns[5].Visible = false;
            dtgListaDeAlunos.Columns[6].Visible = false;
            dtgListaDeAlunos.Columns[7].Visible = false;
            dtgListaDeAlunos.Columns[8].Visible = false;
            dtgListaDeAlunos.Columns[9].Visible = false;
            dtgListaDeAlunos.Columns[10].Visible = false;
            dtgListaDeAlunos.Columns[11].Width = 100;
            dtgListaDeAlunos.Columns[12].Visible = false;
        ...
        {
            processoAluno.PreencheDataGridView();
            //dtgListaDeAlunos.Columns.Clear();
            ...
            //dtgListaDeAlunos.AllowUserToAddRows = false;
